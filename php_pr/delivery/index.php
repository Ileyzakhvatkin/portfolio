<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/templates/base_header_tmp.php'; ?>
...
<main class="page-delivery">
  ...
  <section class="page-delivery__info">
    ...
    <ul class="page-delivery__list">
      <li>
        <b class="page-delivery__item-title">Стандартная доставка - <?=DELIVERY_COST; ?> РУБ / БЕСПЛАТНО (ДЛЯ ЗАКАЗОВ ОТ <?=BACKET_MIN; ?> РУБ)</b>
        <p class="page-delivery__item-desc">
          Примерный срок доставки составит около 2-7 рабочих дней, в зависимости от адреса доставки.
        </p>
      </li>
      <li>
        <b class="page-delivery__item-title">В день покупки - <?=FAST_DELIVERY_COST; ?> РУБ</b>
        <p class="page-delivery__item-desc">
      ...
      <li>
        <b class="page-delivery__item-title">Доставка с примеркой перед покупкой по Москве - <?=DELIVERY_COST; ?> РУБ / БЕСПЛАТНО (ПРИ ВЫКУПЕ НА СУММУ ОТ <?=BACKET_MIN; ?> РУБ)</b>
        <p class="page-delivery__item-desc">
